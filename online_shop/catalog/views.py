...
from catalog.serializers import (CategorySerializer, ProductSerializer, SellerSerializer, DiscountSerializer,
                                 CartSerializer,
                                 AddProductSerializer, DeleteProductSerializer, OrderSerializer)
...
class CartView(APIView):
    ...
    def get(self, request):
        user = request.user
        cart = Product.objects.prefetch_related("cart_set").filter(cart__user=user).values("name", "price", "discount",
